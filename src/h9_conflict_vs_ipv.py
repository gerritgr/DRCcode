...
# --- Weighting ---
USE_WEIGHTS = False          # If True, weight by WEIGHT_VARIABLE for curve + bootstrap
...
def main():
    ...
    # CI band + curve
    ax.fill_between(centers, lo, hi, alpha=0.25, linewidth=0)
    ax.plot(centers, smooth, linewidth=2.5)
